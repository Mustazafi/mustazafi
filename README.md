...
- 🔭 Şu anda **modern web ve mobil projeler** geliştiriyorum.  
- 🌱 Sürekli olarak **Full Stack teknolojileri**, **bulut altyapısı** ve **yapay zekâ** üzerine kendimi geliştiriyorum.  
- 💬 Bana **JavaScript, TypeScript, Python, Node.js, React, NestJS, Docker** ve **veritabanları** hakkında soru sorabilirsin.  
- ⚡ Motto: *“Sizin Fikirleriniz Bizim Teknolojimiz Kodla, Yarat, Feth Et”*
...
> “Bir Yazılımcı sadece kod yazmaz; geleceği şekillendirir.”  
